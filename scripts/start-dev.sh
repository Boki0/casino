...
tell application "Terminal"
    ...
    do script "cd '$ROOT_DIR/wallet-service' && echo 'Starting wallet-service on port 8083...' && ./mvnw spring-boot:run"
end tell
EOF
